// Reading this as: High-growth prop-tech landing page for college students and landlords, with a clean B2B2C startup visual language, leaning toward custom grid layouts, high-contrast mockups, and premium interactive features.
...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 text-[#0f172a] overflow-hidden font-sans selection:bg-teal-500/20 selection:text-[#003057]">
      ...
      <header className="w-full h-18 border-b border-slate-200/60 bg-white/75 backdrop-blur-md sticky top-0 z-30 transition-all">
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          ...
          <button 
            ...
            className="md:hidden p-2 text-slate-650 hover:text-[#003057] focus:outline-none"
          >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-slate-200 bg-white py-4 px-6 space-y-4 shadow-inner">
            ...
            <div className="pt-2 flex flex-col gap-3">
              <Link href="/login" onClick={() => setMobileMenuOpen(false)} className="w-full text-center py-2.5 border border-slate-200 text-[11px] font-bold uppercase tracking-wider text-slate-600 rounded-xl hover:bg-slate-50 transition-all">
                Masuk
              </Link>
              <Link href="/register" onClick={() => setMobileMenuOpen(false)} className="w-full text-center py-2.5 bg-[#003057] text-[11px] font-bold uppercase tracking-wider text-white rounded-xl hover:bg-[#001e38] transition-all">
                Mulai Audit
              </Link>
            </div>
          </div>
      ...
      {/* Main Container - Hero fits initial viewport */}
      <main className="max-w-7xl mx-auto px-6 pt-8 md:pt-12 pb-24 z-10 relative">
        
        {/* Split Hero Section */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[70dvh] mb-16">
          {/* Left Hero Content */}
        ...
        <section id="bento" className="mb-28 max-w-5xl mx-auto space-y-12">
          {/* Headline and explainers stacked vertically - no split header */}
          ...
          {/* Bento Box Grid - exactly 5 cells with background and type diversity */}
        ...
        {/* Asymmetric Workflow Section (1 Highlighted Card to break symmetry - DESIGN_VARIANCE: 8) */}
        <section id="fitur" className="mb-28 max-w-5xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            {/* Step 2 - Highlighted Card (Asymmetry Device) */}
            ...
            <div className="lg:col-span-4 p-8 rounded-2xl bg-white border border-slate-200 shadow-sm relative flex flex-col justify-between hover:shadow-md hover:border-slate-350 transition-all duration-200 text-left">
              <div className="space-y-4">
                ...
                <h3 className="text-base font-extrabold text-[#003057] leading-snug">Terima Scorecard</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
        ...
        <section id="harga" className="mb-28 max-w-4xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            {/* Package 1 */}
            <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm flex flex-col justify-between hover:shadow-md hover:border-slate-300 transition-all duration-300 text-left">
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-xs text-slate-650">
                  ...
                  <li className="flex items-center gap-2.5"><CheckSquare className="h-4 w-4 text-teal-600 shrink-0" /> Uji TDS kualitas kebersihan air bersih</li>
                  ...
                  <li className="flex items-center gap-2.5"><CheckSquare className="h-4 w-4 text-teal-600 shrink-0" /> Laporan scorecard digital + Chatbot AI</li>
                </ul>
              </div>
            ...
            <div className="bg-white border-2 border-[#0f766e] rounded-2xl p-8 shadow-md flex flex-col justify-between relative hover:shadow-lg transition-all duration-300 text-left">
              ...
              <div className="space-y-6">
                ...
                <ul className="space-y-3 text-xs text-slate-650">
                  ...
                  <li className="flex items-center gap-2.5"><CheckSquare className="h-4 w-4 text-[#0f766e] shrink-0" /> Uji TDS Air & WiFi di setiap kosan</li>
        ...
        {/* Composed Featured Testimonial (High-End Editorial typography, max 3 lines, no em-dashes) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center text-left">
            <div className="md:col-span-8 space-y-4">
              ...
              <blockquote className="text-base sm:text-lg font-extrabold text-[#003057] leading-relaxed text-wrap-pretty italic">
                &ldquo;Saya dari luar kota Padang, sehingga survei satu per satu sangat sulit. Menggunakan Inspeksi Grup sangat menghemat biaya tiket pesawat saya. Skor kecocokan visual dari AI Vision sangat akurat.&rdquo;
              </blockquote>
              <div className="pt-2">
            ...
            {faqs.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="border border-slate-200 rounded-xl bg-white overflow-hidden transition-all shadow-sm text-left">
                  ...
                  >
                    <span>{faq.q}</span>
                    <ChevronDown className={`h-4 w-4 text-slate-450 transition-transform duration-300 ${isOpen ? 'transform rotate-180' : ''}`} />
                  </button>
                  {isOpen && (
      ...
      {/* Footer - Logo only, legal links, clean credentials */}
